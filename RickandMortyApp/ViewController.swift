...
//  RickandMortyApp
//
//  Created by Lucia Rigoni Freire on 07/11/22.
//
...
class ViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        button.frame = CGRect(x: 20, y: passwordField.frame.origin.y+passwordField.frame.size.height+10, width: view.frame.size.width-40, height: 52)
